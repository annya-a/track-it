@php
    ...
    $class = match ($status) {
        ...
        TicketStatus::ASSIGNED => 'text-teal-500 bg-teal-100 dark:bg-teal-500 dark:text-teal-100',
        TicketStatus::IN_PROGRESS => 'text-blue-500 bg-blue-100 dark:bg-blue-5 dark:text-blue-100',
